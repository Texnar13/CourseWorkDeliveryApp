...
// ------------------------------------------ Связь с активностью ---------------------------------------
    ...
    private val connectionStatus = MutableLiveData(ConnectionStatusValue.STATUS_NONE)
    val activityConnectionStatus: LiveData<ConnectionStatusValue> = connectionStatus


// -------------------------------------- Загруженные данные ---------------------------------------

    // текущий пользователь
    var currentUser: MutableLiveData<DBUser?> = MutableLiveData(null)
    ...
    private fun connectDB() {
        ...
        viewModelScope.launch {
            ...
            connectionStatus.postValue(ConnectionStatusValue.STATUS_CONNECTED);
        }
    ...
    fun tryRegisterUser(password: String?, address: Array<String?>?, email: String?, name: String?, phone: String?) {
        sendToast("Сначала бек доделаем..))")
...
//        });
    ...
    fun editUser(editedUserData: DBUser) {
...
// ------------------------------------------ Загруженные данные ------------------------------------------
    ...
    // загруженные поездки
    public MutableLiveData<List<DBTrip>> currentLoadedTrips = new MutableLiveData<>();
...
//        });
    ...
    public void tryRegisterUser(String password, String[] address, String email, String name, String phone) {
...
//            });
    ...
    // пометить уведомление прочитанным
    public void markReadAdminNotification(long notificationID) {
